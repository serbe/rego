...
const initialArguments: MessageState = {
  certificateList: [],
  companyList: [],
  contactList: [],
  departmentList: [],
...
const messageInitContext: MessageValues = {
  state: initialArguments,
  dispatch: () => null,
};

export const MessageContext = createContext<MessageValues>(messageInitContext);
...
// export const Messages = (properties: MessageProperties): JSX.Element => {
